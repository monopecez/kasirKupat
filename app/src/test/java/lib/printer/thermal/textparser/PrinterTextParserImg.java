...
public class PrinterTextParserImg implements PrinterTextParserElement {
     ...
     */
    public static String bitmapToHexadecimalString(lib.printer.thermal.Printer printer, Drawable drawable) {
     ...
     */
    public static String bitmapToHexadecimalString(lib.printer.thermal.Printer printer, BitmapDrawable bitmapDrawable) {
     ...
     * @return A hexadecimal string of the image data.
     */
    public static String bitmapToHexadecimalString(lib.printer.thermal.Printer printer, Bitmap bitmap) {
    ...
    public PrinterTextParserImg(PrinterTextParserColumn printerTextParserColumn, String textAlign, String hexadecimalString) {
        lib.printer.thermal.Printer printer = printerTextParserColumn.getLine().getTextParser().getPrinter();
